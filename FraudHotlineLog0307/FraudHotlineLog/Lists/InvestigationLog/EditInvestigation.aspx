                             ...
                             <!-- ikarstein: This line is important for "Attachments" --> 
                                 ...
                                 <tr> 
                                  ...
                                  <tr> 
                                        <td  width="190px"  valign="top"  class="ms-formlabel"> 
                                            <h3  class="ms-standardheader"> 
                                                <nobr>Investigation #</nobr> 
                                        </h3> 
                                        </td> 
                                        <td  width="400px"  valign="top"  class="ms-formbody"> 
                                            <SharePoint:FormField  runat="server"  ID="Field_InvestigationNumber"  ControlMode="Edit"  FieldName="InvestigationNumber"  /> 
                                            <SharePoint:FieldDescription  runat="server"  ID="Field_InvestigationNumber_Description"  FieldName="InvestigationNumber" ControlMode="Edit"  />
                                 ...
                                 <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="Field_InvestigationStatus"  ControlMode="Edit" FieldName="InvestigationStatus"   />
                                             <SharePoint:FieldDescription  runat="server"  ID="Field_InvestigationStatus_Description"  FieldName="InvestigationStatus" ControlMode="Edit"  />
                                         </td> 
                                 </tr>
                                 <tr> 
                                         <td  width="190px"  valign="top"  class="ms-formlabel"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="Field_InvestigationType"  ControlMode="Edit"  FieldName="InvestigationType"  />
                                             <SharePoint:FieldDescription  runat="server"  ID="Field_InvestigationType_Description"  FieldName="InvestigationType" ControlMode="Edit"  />
                                 ...
                                 <tr> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="Field_InvestigationDept"  ControlMode="Edit"  FieldName="InvestigationDept"  />
                                             <SharePoint:FieldDescription  runat="server"  ID="Field_InvestigationDept_Description"  FieldName="InvestigationDept" ControlMode="Edit"  /> 
                                         </td> 
                                 </tr> 
                                 <tr> 
                                         <td  width="190px"  valign="top"  class="ms-formlabel"> 
                                         ...
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="Field_Auditor"  ControlMode="Edit"  FieldName="Auditor"  />
                                             <SharePoint:FieldDescription  runat="server"  ID="Field_Auditor_Description"  FieldName="Auditor" ControlMode="Edit"  /> 
                                         </td> 
                                 </tr>
                                 <tr> 
                                         <td  width="190px"  valign="top"  class="ms-formlabel"> 
                                 ...
                                 <tr> 
                                         <td  width="190px"  valign="top"  class="ms-formlabel"> 
                                             <h3  class="ms-standardheader"> 
                                                 <nobr>Hours Spent</nobr> 
                                             </h3> 
                                         </td> 
                                         <td  width="400px"  valign="top"  class="ms-formbody"> 
                                             <SharePoint:FormField  runat="server"  ID="Field_HoursSpent"  ControlMode="Edit"  FieldName="HoursSpent"  />
                                             <SharePoint:FieldDescription  runat="server"  ID="Field_HoursSpent_Description"  FieldName="HoursSpent" ControlMode="Edit"  /> 
                                         </td> 
                                 </tr>
