...
<%@ Page language="C#" MasterPageFile="~masterurl/default.master"    Inherits="Microsoft.SharePoint.WebPartPages.NewInvestigationWebPartPage,Microsoft.SharePoint,Version=14.0.0.0,Culture=neutral,PublicKeyToken=71e9bce111e9429c" meta:webpartpageexpansion="full" meta:progid="SharePoint.WebPartPage.Document"  %>
	...
	<table cellpadding="0" cellspacing="0" id="onetIDListForm" style="width:100%">
     ...
     <!-- Customization Start -->
      <table id="SQFormTable"  border="0"  width="100%"> 
                     <div>
        <WebPartPages:WebPartZone runat="server" FrameType="None" ID="ContentMain" Title="loc:Main" Visible="true" />
        <p>
            Investigations are launched from the Call Log list. Please create a call log item and launch your investigation from there.
        </p>
    </div>
